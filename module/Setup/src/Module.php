...
class Module implements ConfigProviderInterface, InitProviderInterface
{
    ...
    public function onMergeConfig(ModuleEvent $e)
    {
        ...
        if (array_key_exists('setup', $config) &&
            array_key_exists('setup_session_timeout', $config['setup']) &&
            is_int($config['setup']['setup_session_timeout']) &&
            array_key_exists('caches', $config) &&
            array_key_exists('SetupCache', $config['caches']) &&
            array_key_exists('options', $config['caches']['SetupCache'])) {
